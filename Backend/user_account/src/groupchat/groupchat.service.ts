...
export class GroupchatService {
    ...
    async create(createGroupchatDto: any) {
        return await this.prisma.groupchat.create({
            data:{
                namegb : createGroupchatDto.namegb,
                usersgb : {connect : [{id : createGroupchatDto.usersgb} ]},
                admins : {connect : [{id : createGroupchatDto.admins} ]},
    ...
    removeadminuser(id: string, iduser : string , iduserconnected : string) { 
        ...
        admins.admins.prototype.forEach(element => {
            console.log(element);
        });
