...
const Dms = (props:any) => {
    ...
    let user:chatUser = { userName: "ibrahim", pic: "https://lh3.googleusercontent.com/a/ACg8ocJI_D7IP06LBonwDUOt8-LC8MeyK9BEW2o_TQje-YjnEwY=s96-c", id: "cdb272fa-d1e9-4105-b2cf-eb23aa2f9fa0" }
